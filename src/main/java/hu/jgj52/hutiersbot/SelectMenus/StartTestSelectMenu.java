...
public class StartTestSelectMenu extends SelectMenu {
    ...
    private static final Map<Gamemode, List<Player>> testers = new HashMap<>();
    ...
    public void execute(StringSelectInteractionEvent event) {
        try {
            ...
            event.getChannel().sendMessage("here@").addEmbeds(embed.build()).setComponents(ActionRow.of(new JoinQueueButton().button())).queue();
